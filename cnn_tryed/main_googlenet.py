...
if __name__ == '__main__':
    #1.一些初始化定义
    data_set_name = 'CIFAR10'#'IMAGENET' #'SIFT' # 'CIFAR10' # 'MNIST'  #   'GLOVE'# 'CIFAR10'
    ...
    if data_set_name =='CIFAR10':
        #model = GoogLeNet(num_classes=10, False, True)
        model = GoogLeNet( )
        ...
        inputs_ = np.zeros((1000, 1024), float)
        ...
        inputs_ = np.zeros((1000, 150528), float) #原始数据长度为224*224*3
        img_id = 0
